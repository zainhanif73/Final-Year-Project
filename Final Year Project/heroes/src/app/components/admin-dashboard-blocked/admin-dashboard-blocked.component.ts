...
@Component({
  selector: 'app-admin-dashboard-blocked',
  templateUrl: './admin-dashboard-blocked.component.html',
  styleUrls: ['./admin-dashboard-blocked.component.css']
})

export class AdminDashboardBlockedComponent implements OnInit {
