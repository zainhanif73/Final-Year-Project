...
@Component({
  selector: 'app-admin-dashboard-blockeddoctors',
  templateUrl: './admin-dashboard-blockeddoctors.component.html',
  styleUrls: ['./admin-dashboard-blockeddoctors.component.css']
})
export class AdminDashboardBlockeddoctorsComponent implements OnInit {
